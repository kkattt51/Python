{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "# место для кода\n",
    "print(smalldf.iloc[2, 0])\n",
    "print(smalldf.loc['Maria', 'Age'])\n",
    "print(smalldf['Age'][2])"
   ]
  },
  {
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "      Chord length [m]  FS velocity [m/s]  SSD thickness [m]  \\\n",
       "0               0.3048               71.3           0.002663   \n",
       "1               0.3048               71.3           0.002663   \n",
       "2               0.3048               71.3           0.002663   \n",
       "3               0.3048               71.3           0.002663   \n",
       "4               0.3048               71.3           0.002663   \n",
       "...                ...                ...                ...   \n",
       "1498            0.1016               39.6           0.052849   \n",
       "1499            0.1016               39.6           0.052849   \n",
       "1500            0.1016               39.6           0.052849   \n",
       "1501            0.1016               39.6           0.052849   \n",
       "1502            0.1016               39.6           0.052849   \n",
       "\n",
       "      Sound pressure [dB]  \n",
       "0                 126.201  \n",
       "1                 125.201  \n",
   ...
   "source": [
    "# место для кода\n",
    "df2 = df.loc[:, [c for c in df.columns if len(c)>15]]\n",
    "df2\n"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    ...
    "print(\"Mean: {0:.2f}, \\nMedian: {1:.2f}\".format(sp.mean(), sp.median()),'\\n')\n",
    "print(\"Squares: {0:.2f}\".format((sp**2).mean()))"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "Name                                         \n",
       "Bob      15      70      M     NaN        NaN\n",
       "Alice    18      50      F     NaN        NaN\n",
       "Maria    15      55      F     NaN        NaN\n",
       "John     12      85      M     NaN        NaN\n",
       "Kevin    14      68      M     NaN        NaN\n",
       "Donald   20     110      M     NaN        NaN"
      ]
     },
     "execution_count": 86,
     "metadata": {},
   ...
   "source": [
    "other = pd.DataFrame({'Salary': [100, 150, 110, 90, 105, 500], 'Education': [5, 10, 7, 3, 4, 0]})\n",
    "new_frame = smalldf.join(other)\n",
    "new_frame"
   ]
  },
  {
